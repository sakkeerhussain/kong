...
describe("plugins", function()
  ...
  it("rejects incorrect sync status", function()
    ...
    assert.equal("expected one of: config_unsync, unknown, normal, kong_version_incompatible, plugin_set_incompatible, plugin_version_incompatible", err.sync_status)
  end)
